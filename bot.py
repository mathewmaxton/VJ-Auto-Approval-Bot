...
async def approve(_, m : Message):
    ...
    try:
        ...
        await app.send_video(kk.id,img, "**Hello {}!\nWelcome To {}\n\n__Powerd By : @billabombay**".format(m.from_user.mention, m.chat.title))
        add_user(kk.id)
    ...
    try:
        ...
        if m.chat.type == enums.ChatType.PRIVATE:
            keyboard = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("🗯 Channel", url="https://t.me/billabombay"),
                        InlineKeyboardButton("💬 Support", url="https://t.me/rcforeverr")
                    ],[
                        InlineKeyboardButton("➕ Add me to your Chat ➕", url="https://t.me/GxC_Manager_Bot?startgroup")
                    ]
                ]
            )
            ...
            keyboar = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("💁‍♂️ Start me private 💁‍♂️", url="https://t.me/GxC_Manager_Bot?startgroup")
                    ]
                ]
            )
            add_group(m.chat.id)
